...
type AdminSection = "aliases" | "hidden-players" | null;
    ...
    return (
        <div className="lg:relative">
            <aside className="hidden lg:block">
                <div className="fixed top-24 z-30 w-[245px] left-[max(1rem,calc(50%-36rem))]">
                            ...
                            {items.map((it) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={[
                                            "w-full text-left block rounded-2xl border border-white/40 px-3 py-2 text-sm font-medium text-zinc-900 shadow-[0_0_0_1px_rgba(255,159,198,0.10)] backdrop-blur transition",
            ...
            <main className="min-w-0">
                ...
                <section
                    id="aliases"
                    className={["mt-6 scroll-mt-28", activeSection === "aliases" ? "" : "lg:hidden"].join(" ")}
                >
                    {aliases}
                </section>
                ...
                <section
                    ...
                    className={[
                        "mt-6 scroll-mt-28",
                        activeSection === "hidden-players" ? "" : "lg:hidden",
                    ].join(" ")}
                >
                    {hiddenPlayers}
                </section>
